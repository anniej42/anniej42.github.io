...
rsn.sideScroll.resize = function() {
    ...
    var marginTop = windowHeight * 0.2;
    var marginBottom = windowHeight * 0.2;
...
rsn.sideScroll.availableSpace = function() {
    ...
    var usedSpace = headerHeight + footerHeight + contentPadding
